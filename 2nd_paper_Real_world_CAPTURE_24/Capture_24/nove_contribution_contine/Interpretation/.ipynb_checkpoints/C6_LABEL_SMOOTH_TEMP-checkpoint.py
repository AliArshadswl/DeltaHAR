...
# =============================================================================
class ContribConfig:
    C1_DUAL_DOMAIN_EMBEDDING   = True   # FFT patch branch   # done
    C2_CALANET_SKIP_AGG        = True   # multi-layer skip aggregation  #done   
    C3_CIRCADIAN_BIAS          = True   # patch-level time bias MLP     #done
    C4_MULTISCALE_PATCHING     = True   # hierarchical additive multi-scale  #done
    C5_FREQ_AUGMENTATION       = True   # band-pass / axis-perm / warp #done
    C6_LABEL_SMOOTH_TEMP       = False   # smoothed CE + learnable τ    
...
class Config:
    ...
    OUTPUT_DIR = Path("/mnt/share/ali/processed/C6_LABEL_SMOOTH_TEMP/")
